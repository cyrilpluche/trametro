...
router.get('/find_one_from_db', downloadMiddleware.fromURL, tripController.findOneMW, parseMiddleware.parse, filterMiddleware.filtre, parseMiddleware.intToString, travellerController.initStatus, scheduleController.findOne);
