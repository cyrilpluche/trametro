...
router.get('/find_one_from_db', downloadMiddleware.fromURL, tripController.findOne, parseMiddleware.parse, filterMiddleware.filtre, parseMiddleware.intToString, scheduleController.findOne);
